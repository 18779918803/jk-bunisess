                                            ...
                                            <select class="form-control select2" style="width: 100%" id="organId"
                                                ...
                                                <#if  organList??>
                                                    <#list organList as item>
                                                        <option value="${item.id}" ${((bankOrgan.organId==item.id)?string("selected",""))!}>${item.name}</option>
                                                    </#list>
                                                </#if>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="userName" name="userName"
                                                   value="${bankOrgan.userName!}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="bankName" name="bankName"
                                                   value="${bankOrgan.bankName!}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="bankAccount" name="bankAccount"
                                                   value="${bankOrgan.bankAccount!}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!-- 隐藏域 -->
                            <input type="hidden" name="id" id="id" value="${bankOrgan.id!}">
                        </div>
                    </form>
                </div>
            </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/gck/bankOrgan/update",
