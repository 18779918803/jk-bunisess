...
@Component
public class DebtorGeneralManagerListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        Integer loanId = loan.getDebtorId();
        List<User> users = loanMapper.getUserByRoleAndOrgan(ConstUtils.SUB_GENERAL_MANAGER, loanId);  //表示的是借款方会计
