...
@Component
public class LeaderGeneralManagerListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        List<User> users = loanMapper.getUserByRoleAndOrgan(ConstUtils.SUB_GENERAL_MANAGER, loanId);  //表示的是贷款方总经理
