...
@Component
public class DebtorAccountingListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        List<User> users = loanMapper.getUserByRoleAndOrgan(ConstUtils.SUB_ACCOUNTING, loanId);  //表示的是借款方会计
