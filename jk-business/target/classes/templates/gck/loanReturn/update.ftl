                            ...
                            <div class="row">
                                            ...
                                            <select class="form-control select2" style="width: 100%" id="loanId"
                                                ...
                                                <@dic type="" ; dicList>
                                                    <#list dicList as item>
                                                        <option value="${item.code}" ${((loanReturn.loanId==item.code)?string("selected",""))!}>${item.name}</option>
                                                    </#list>
                                                </@dic>
                                            </select>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="amount" name="amount" value="${loanReturn.amount!}"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group input-group-addon-right-radius">
                                                <input type="text" class="form-control pull-right" name="tradeTime"
                                                       id="tradeTime"
                                                       value="${(loanReturn.tradeTime?string("yyyy-MM-dd HH:mm:ss"))!}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" style="width: 100%" id="typle"
                                                ...
                                                <@dic type="" ; dicList>
                                                    <#list dicList as item>
                                                        <option value="${item.code}" ${((loanReturn.typle==item.code)?string("selected",""))!}>${item.name}</option>
                                                    </#list>
                                                </@dic>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea rows="2" name="remark"
                                                      class="form-control">${loanReturn.remark!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- 隐藏域 -->
                                <input type="hidden" name="id" id="id" value="${loanReturn.id!}">
                            </div>
                    </form>
                </div>
            </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/gck/loanReturn/update",
