                ...
                <div class="box-body">
                    ...
                    <div class="table-toolbar" id="table-toolbar">
                        <@shiro.hasPermission name="contract:contract:excelOut">
                            <@krt.excelOut id="excelOutBtn" url="${basePath}/gck/loan/debtorExcelOut"></@krt.excelOut>
                        </@shiro.hasPermission>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            datatable = $('#datatable').DataTable({
                ajax: {
                    url: "${basePath}/gck/loan/totalDebtor",
                    type: "post",
                    data: function (d) {
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            return '<@shiro.hasPermission name="Loan:loan:list">'
                                + '<button class="btn btn-xs btn-success searchBtn" rid="' + row.debtorId + '">'
            ...
            $(document).on("click", ".searchBtn", function () {
                ...
                top.krt.tab.openTab("归还本金和利息", "${basePath}/gck/loan/list?debtorId=" + id)
